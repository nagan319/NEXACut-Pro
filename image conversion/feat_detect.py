...
from constants.image_conversion import MIN_CONTOUR_AREA, MIN_CONTOUR_DISTANCE_FROM_EDGE, CORNER_SEARCH_POINT_DELTA, MIN_CORNER_ANGLE, MIN_CORNER_SEPARATION
